...
var _constants = __webpack_require__(71647);
...
var _script = _interopRequireDefault(__webpack_require__(72189));
...
var _sideEffect = _interopRequireDefault(__webpack_require__(11585));

var _ampContext = __webpack_require__(78000);

var _headManagerContext = __webpack_require__(15850);

var _amp = __webpack_require__(45646);
      ...
      fontDefinitions.forEach(fontDef => {
        ...
        if (!fontContent) {
          ...
          */
          ...
          result = result.replace('</head>', `<style data-href="${url}"${nonceStr}>${fontContent}</style></head>`); // Remove inert font tag
...
var _getRouteFromAssetPath = _interopRequireDefault(__webpack_require__(98324));
var _constants = __webpack_require__(71647);
...
var _detectLocaleCookie = __webpack_require__(91824);
var _detectDomainLocale = __webpack_require__(61085);
var _denormalizePagePath = __webpack_require__(74522);
 ...
 */
var h=__webpack_require__(67294);function n(a,d){a.enqueue(d);return 0<a.desiredSize}var q=new TextEncoder;function r(a,d){"function"===typeof a.error?a.error(d):a.close()}var t=JSON.stringify,u=Symbol.for("react.module.reference"),v=60103,w=60107,x=60112,y=60115,z=60116;if("function"===typeof Symbol&&Symbol.for){var A=Symbol.for;v=A("react.element");w=A("react.fragment");x=A("react.forward_ref");y=A("react.memo");z=A("react.lazy")}var B=Array.isArray,C=h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;
function G(a){console.error(a)}function H(a,d,c){var b=[],e={status:0,fatalError:null,destination:null,bundlerConfig:d,cache:new Map,nextChunkId:0,pendingChunks:0,pingedSegments:b,completedModuleChunks:[],completedJSONChunks:[],completedErrorChunks:[],writtenSymbols:new Map,writtenModules:new Map,onError:void 0===c?G:c,toJSON:function(a,b){return I(e,this,a,b)}};e.pendingChunks++;a=J(e,a);b.push(a);return e}
function K(a,d,c,b){if(null!==c&&void 0!==c)throw Error("Refs cannot be used in server components, nor passed to client components.");if("function"===typeof a)return a(b);if("string"===typeof a)return[v,a,d,b];if("symbol"===typeof a)return a===w?b.children:[v,a,d,b];if(null!=a&&"object"===typeof a){if(a.$$typeof===u)return[v,a,d,b];switch(a.$$typeof){case x:return a=a.render,a(b,void 0);case y:return K(a.type,d,c,b)}}throw Error("Unsupported server component type: "+L(a));}
function J(a,d){var c={id:a.nextChunkId++,model:d,ping:function(){var b=a.pingedSegments;b.push(c);1===b.length&&M(a)}};return c}function N(a){return Object.prototype.toString.call(a).replace(/^\[object (.*)\]$/,function(a,c){return c})}function O(a){var d=JSON.stringify(a);return'"'+a+'"'===d?a:d}
function L(a){switch(typeof a){case "string":return JSON.stringify(10>=a.length?a:a.substr(0,10)+"...");case "object":if(B(a))return"[...]";a=N(a);return"Object"===a?"{...}":a;case "function":return"function";default:return String(a)}}
function P(a,d){if(B(a)){for(var c="[",b=0;b<a.length;b++){0<b&&(c+=", ");if(6<b){c+="...";break}var e=a[b];c=""+b===d&&"object"===typeof e&&null!==e?c+P(e):c+L(e)}return c+"]"}c="{";b=Object.keys(a);for(e=0;e<b.length;e++){0<e&&(c+=", ");if(6<e){c+="...";break}var k=b[e];c+=O(k)+": ";var f=a[k];c=k===d&&"object"===typeof f&&null!==f?c+P(f):c+L(f)}return c+"}"}
function I(a,d,c,b){switch(b){case v:return"$";case z:throw Error("React Lazy Components are not yet supported on the server.");}for(;"object"===typeof b&&null!==b&&b.$$typeof===v;){var e=b;try{b=K(e.type,e.key,e.ref,e.props)}catch(m){if("object"===typeof m&&null!==m&&"function"===typeof m.then)return a.pendingChunks++,a=J(a,b),d=a.ping,m.then(d,d),"@"+a.id.toString(16);R(a,m);a.pendingChunks++;d=a.nextChunkId++;S(a,d,m);return"@"+d.toString(16)}}if(null===b)return null;if("object"===typeof b){if(b.$$typeof===
u){e=b.filepath+"#"+b.name;var k=a.writtenModules,f=k.get(e);if(void 0!==f)return d[0]===v&&"1"===c?"@"+f.toString(16):"$"+f.toString(16);try{var l=a.bundlerConfig[b.filepath][b.name];a.pendingChunks++;var g=a.nextChunkId++,D=t(l),E="M"+g.toString(16)+":"+D+"\n";var F=q.encode(E);a.completedModuleChunks.push(F);k.set(e,g);return d[0]===v&&"1"===c?"@"+g.toString(16):"$"+g.toString(16)}catch(m){return a.pendingChunks++,d=a.nextChunkId++,S(a,d,m),"$"+d.toString(16)}}return b}if("string"===typeof b)return a=
"$"===b[0]||"@"===b[0]?"$"+b:b,a;if("boolean"===typeof b||"number"===typeof b||"undefined"===typeof b)return b;if("function"===typeof b){if(/^on[A-Z]/.test(c))throw Error("Event handlers cannot be passed to client component props. Remove "+(O(c)+" from these props if possible: "+P(d)+"\nIf you need interactivity, consider converting part of this to a client component."));throw Error("Functions cannot be passed directly to client components because they're not serializable. Remove "+(O(c)+" ("+(b.displayName||
b.name||"function")+") from this object, or avoid the entire object: "+P(d)));}if("symbol"===typeof b){l=a.writtenSymbols;g=l.get(b);if(void 0!==g)return"$"+g.toString(16);g=b.description;if(Symbol.for(g)!==b)throw Error("Only global symbols received from Symbol.for(...) can be passed to client components. The symbol Symbol.for("+(b.description+") cannot be found among global symbols. Remove ")+(O(c)+" from this object, or avoid the entire object: "+P(d)));a.pendingChunks++;d=a.nextChunkId++;c=t(g);
c="S"+d.toString(16)+":"+c+"\n";c=q.encode(c);a.completedModuleChunks.push(c);l.set(b,d);return"$"+d.toString(16)}if("bigint"===typeof b)throw Error("BigInt ("+b+") is not yet supported in client component props. Remove "+(O(c)+" from this object or use a plain number instead: "+P(d)));throw Error("Type "+typeof b+" is not supported in client component props. Remove "+(O(c)+" from this object, or avoid the entire object: "+P(d)));}function R(a,d){a=a.onError;a(d)}
function T(a,d){null!==a.destination?(a.status=2,r(a.destination,d)):(a.status=1,a.fatalError=d)}function S(a,d,c){var b="";try{if(c instanceof Error){var e=String(c.message);b=String(c.stack)}else e="Error: "+c}catch(k){e="An error occurred but serializing the error message failed."}c={message:e,stack:b};d="E"+d.toString(16)+":"+t(c)+"\n";d=q.encode(d);a.completedErrorChunks.push(d)}
function M(a){var d=C.current,c=U;C.current=V;U=a.cache;try{var b=a.pingedSegments;a.pingedSegments=[];for(var e=0;e<b.length;e++){var k=b[e];var f=a;try{for(var l=k.model;"object"===typeof l&&null!==l&&l.$$typeof===v;){var g=l;k.model=l;l=K(g.type,g.key,g.ref,g.props)}var D=k.id,E=t(l,f.toJSON),F="J"+D.toString(16)+":"+E+"\n";var m=q.encode(F);f.completedJSONChunks.push(m)}catch(p){if("object"===typeof p&&null!==p&&"function"===typeof p.then){var Q=k.ping;p.then(Q,Q)}else R(f,p),S(f,k.id,p)}}null!==
a.destination&&W(a,a.destination)}catch(p){R(a,p),T(a,p)}finally{C.current=d,U=c}}
function W(a,d){for(var c=a.completedModuleChunks,b=0;b<c.length;b++)if(a.pendingChunks--,!n(d,c[b])){a.destination=null;b++;break}c.splice(0,b);c=a.completedJSONChunks;for(b=0;b<c.length;b++)if(a.pendingChunks--,!n(d,c[b])){a.destination=null;b++;break}c.splice(0,b);c=a.completedErrorChunks;for(b=0;b<c.length;b++)if(a.pendingChunks--,!n(d,c[b])){a.destination=null;b++;break}c.splice(0,b);0===a.pendingChunks&&d.close()}
function X(){throw Error("This Hook is not supported in Server Components.");}function Y(){if(!U)throw Error("Refreshing the cache is not supported in Server Components.");}
var U=null,V={useMemo:function(a){return a()},useCallback:function(a){return a},useDebugValue:function(){},useDeferredValue:X,useTransition:X,getCacheForType:function(a){if(!U)throw Error("Reading the cache is only supported while rendering.");var d=U.get(a);void 0===d&&(d=a(),U.set(a,d));return d},readContext:X,useContext:X,useReducer:X,useRef:X,useState:X,useInsertionEffect:X,useLayoutEffect:X,useImperativeHandle:X,useEffect:X,useId:X,useMutableSource:X,useSyncExternalStore:X,useCacheRefresh:function(){return Y}};
exports.renderToReadableStream=function(a,d,c){var b=H(a,d,c?c.onError:void 0),e=new ReadableStream({start:function(){M(b)},pull:function(a){if(e.locked)if(1===b.status)b.status=2,r(a,b.fatalError);else if(2!==b.status){b.destination=a;try{W(b,a)}catch(f){R(b,f),T(b,f)}}},cancel:function(){}});return e};
 ...
 * LICENSE file in the root directory of this source tree.
 */
var h={stream:!0},k=new Map,m=60103,n=60116;if("function"===typeof Symbol&&Symbol.for){var q=Symbol.for;m=q("react.element");n=q("react.lazy")}function r(a,b,c){this._status=a;this._value=b;this._response=c}r.prototype.then=function(a){0===this._status?(null===this._value&&(this._value=[]),this._value.push(a)):a()};
function t(a){switch(a._status){case 3:return a._value;case 1:var b=JSON.parse(a._value,a._response._fromJSON);a._status=3;return a._value=b;case 2:b=a._value;for(var c=b.chunks,d=0;d<c.length;d++){var e=k.get(c[d]);if(null!==e)throw e;}c=__webpack_require__(b.id);b="*"===b.name?c:""===b.name?c.__esModule?c.default:c:c[b.name];a._status=3;return a._value=b;case 0:throw a;default:throw a._value;}}function u(){var a=v(this,0);return t(a)}function w(a,b){return new r(3,b,a)}
function x(a){if(null!==a)for(var b=0;b<a.length;b++)(0,a[b])()}function y(a,b){if(0===a._status){var c=a._value;a._status=4;a._value=b;x(c)}}function z(a,b){a._chunks.forEach(function(a){y(a,b)})}function v(a,b){var c=a._chunks,d=c.get(b);d||(d=new r(0,null,a),c.set(b,d));return d}
function B(a,b,c){switch(c[0]){case "$":if("$"===c)return m;if("$"===c[1]||"@"===c[1])return c.substring(1);b=parseInt(c.substring(1),16);a=v(a,b);return t(a);case "@":return b=parseInt(c.substring(1),16),a=v(a,b),{$$typeof:n,_payload:a,_init:t}}return c}function C(a){z(a,Error("Connection closed."))}
function D(a,b){if(""!==b){var c=b[0],d=b.indexOf(":",1),e=parseInt(b.substring(1,d),16);d=b.substring(d+1);switch(c){case "J":b=a._chunks;(c=b.get(e))?0===c._status&&(a=c._value,c._status=1,c._value=d,x(a)):b.set(e,new r(1,d,a));break;case "M":b=a._chunks;c=b.get(e);d=JSON.parse(d,a._fromJSON);for(var p=d.chunks,g=0;g<p.length;g++){var f=p[g];if(void 0===k.get(f)){var A=__webpack_require__.e(f),l=k.set.bind(k,f,null),G=k.set.bind(k,f);A.then(l,G);k.set(f,A)}}c?0===c._status&&(a=c._value,c._status=
2,c._value=d,x(a)):b.set(e,new r(2,d,a));break;case "S":c=JSON.parse(d);a._chunks.set(e,w(a,Symbol.for(c)));break;case "E":b=JSON.parse(d);c=Error(b.message);c.stack=b.stack;b=a._chunks;(d=b.get(e))?y(d,c):b.set(e,new r(4,c,a));break;default:throw Error("Error parsing the data. It's probably an error code or network corruption.");}}}
function E(a){return function(b,c){return"string"===typeof c?B(a,this,c):"object"===typeof c&&null!==c?(b=c[0]===m?{$$typeof:m,type:c[1],key:c[2],ref:null,props:c[3],_owner:null}:c,b):c}}function F(){var a=new TextDecoder;a={_chunks:new Map,readRoot:u,_partialRow:"",_stringDecoder:a};a._fromJSON=E(a);return a}
function H(a,b){function c(b){var g=b.value;if(b.done)C(a);else{b=g;g=a._stringDecoder;for(var f=b.indexOf(10);-1<f;){var p=a._partialRow;var l=b.subarray(0,f);l=g.decode(l);D(a,p+l);a._partialRow="";b=b.subarray(f+1);f=b.indexOf(10)}a._partialRow+=g.decode(b,h);return e.read().then(c,d)}}function d(b){z(a,b)}var e=b.getReader();e.read().then(c,d)}exports.createFromFetch=function(a){var b=F();a.then(function(a){H(b,a.body)},function(a){z(b,a)});return b};
exports.createFromReadableStream=function(a){var b=F();H(b,a);return b};
exports.createFromXHR=function(a){function b(){for(var b=a.responseText,c=e,f=b.indexOf("\n",c);-1<f;)c=d._partialRow+b.substring(c,f),D(d,c),d._partialRow="",c=f+1,f=b.indexOf("\n",c);d._partialRow+=b.substring(c);e=b.length}function c(){z(d,new TypeError("Network error"))}var d=F(),e=0;a.addEventListener("progress",b);a.addEventListener("load",function(){b();C(d)});a.addEventListener("error",c);a.addEventListener("abort",c);a.addEventListener("timeout",c);return d};
...
var _path = __webpack_require__(71017);
...
var _react = _interopRequireDefault(__webpack_require__(67294));
var _server = _interopRequireDefault(__webpack_require__(21152));
...
var _amp = __webpack_require__(45646);
var _ampContext = __webpack_require__(78000);
var _constants1 = __webpack_require__(71647);
var _head = __webpack_require__(72717);
var _headManagerContext = __webpack_require__(15850);
var _loadable = _interopRequireDefault(__webpack_require__(23668));
var _loadableContext = __webpack_require__(3982);
...
if (true) {
    Writable = (__webpack_require__(12781).Writable);
    ...
    tryGetPreviewData = (__webpack_require__(57742).tryGetPreviewData);
    warn = (__webpack_require__(84332).warn);
    postProcess = (__webpack_require__(77812)/* ["default"] */ .Z);
} else {}
function noRouter() {
...
async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    let isPreview;
    let previewData;
    if ((isSSG || getServerSideProps) && !isFallback && !false) {
    ...
    const inAmpMode =  true && (0, _amp).isInAmpMode(ampState);
        ...
        if ( true && Document.getInitialProps) {
            ...
            if (concurrentFeatures) {
                bodyResult = async ()=>{
                    ...
                    return  false ? 0 : await renderToNodeStream(content, generateStaticHTML);
                };
            } else {
                const content = ctx.err && ErrorDebug ? /*#__PURE__*/ _react.default.createElement(Body, null, /*#__PURE__*/ _react.default.createElement(ErrorDebug, {
                    error: ctx.err
...
module.exports = __webpack_require__(99651)
...
const colorConvert = __webpack_require__(65819);
...
const escapeStringRegexp = __webpack_require__(18094);
const ansiStyles = __webpack_require__(68756);
const stdoutColor = (__webpack_require__(14824).stdout);

const template = __webpack_require__(50464);
...
var conversions = __webpack_require__(87305);
var route = __webpack_require__(63098);
...
const hasFlag = __webpack_require__(38901);
