...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __webpack_require__(13933)(stream_module);
...
var _nodeFetch = _interopRequireWildcard(__webpack_require__(16037));
function _interopRequireWildcard(obj) {
    if (obj && obj.__esModule) {
        return obj;
    } else {
...
var iconv = __webpack_require__(30070)
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(78748) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
        encodeSkipVals: [{from: 0xED40, to: 0xF940}],
    },
    'csshiftjis': 'shiftjis',
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(27686) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(22569) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(22569).concat)(__webpack_require__(81463)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(22569).concat)(__webpack_require__(81463)) },
        gb18030: function() { return __webpack_require__(20399) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(76264) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(58894) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(58894).concat)(__webpack_require__(69738)) },
...
// We support Browserify by skipping automatic module discovery and requiring modules directly.
var modules = [
    __webpack_require__(88362),
    __webpack_require__(91692),
    __webpack_require__(7237),
    __webpack_require__(62226),
    __webpack_require__(64480),
    __webpack_require__(1378),
    __webpack_require__(75583),
    __webpack_require__(65740),
];
...
var bomHandling = __webpack_require__(26341),
    iconv = module.exports;
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(51881); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(55722)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(70014)(iconv);
}
